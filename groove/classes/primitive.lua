...
--Image: is a positionable object that draws an image
IMAGE = Class{
    __includes = {ELEMENT, POS},
    init = function(self, _x, _y, _image, _sx, _sy)
...
function IMAGE:draw()
    ...
    love.graphics.draw(img.image, img.pos.x, img.pos.y, 0, img.sx, img.sy)
